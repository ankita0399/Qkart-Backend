...
describe("Cart test", () => {
  ...
  describe("Checkout", () => {
    ...
    it("should update user balance and empty the cart on success", async () => {
      ...
      // const originalWalletMoney = userOneFinal.walletMoney;
      // const cartTotalValue = cartWithProductsUserOne.totalValue;

      // const expectedWalletBalance = originalWalletMoney - cartTotalValue;
